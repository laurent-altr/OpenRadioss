...
!               if(thk(i) < em6) then
!                 write(6,*) '2 Warning: Element ',i,' thickness is too small: ',thk(i)
!                 write(6,*) "deezz = ",dezz(i)," thkly = ",thkly(i)," off = ",off(i)
!                 write(6,*) "dam_nl = ",dlam_nl,"sigy = ",sigy(i),"dplanl = ",dplanl(i),"sig_dseqdsig = ",sig_dseqdsig(i)
!                 write(6,*) "s13 = ",s13(i),"*","cstf(i,1,1) = ",cstf(i,1,1),"*",(depsxx(i) - dlam_nl*normxx(i))
!                 write(6,*) "s23 = ",s23(i),"*","cstf(i,2,2) = ",cstf(i,2,2),"*",(depsyy(i) - dlam_nl*normyy(i))
!                 write(6,*) "s43 = ",s43(i),"*","cstf(i,4,4) = ",cstf(i,4,4),"*",(depsxy(i) - dlam_nl*normxy(i))
!               end if
              endif
            enddo
          endif
