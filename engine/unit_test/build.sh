...
/opt/intel/oneapi/compiler/2024.0/bin/ifort -static-intel -rdynamic -qopenmp -qopenmp-link=static *.o  -o unit_test1   -L/opt/intel/oneapi/compiler/2024.0/lib/clang/17/lib/x86_64-unknown-linux-gnu  -ldl -ldl -lrt -lstdc++ 

#/opt/intel/oneapi/compiler/2024.0/bin/ifort -static-intel -rdynamic -qopenmp -qopenmp-link=static *.o  -o unit_test1   -L/opt/intel/oneapi/compiler/2024.0/lib/clang/17/lib/x86_64-unknown-linux-gnu  -ldl   -L/opt/intel/oneapi/mpi/2021.11/lib -L/opt/intel/oneapi/mpi/2021.11/lib/release  -lmpi -lmpifort -ldl -lrt -lstdc++ -lirng -lirng 
