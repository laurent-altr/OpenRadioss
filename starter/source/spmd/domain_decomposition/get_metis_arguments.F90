...
! ----------------------------------------------------------------------------------------------------------------------
          ...
          metis_random_seed = 0
          ! look for -METIS_SEED in the command line arguments, and set metis_random_seed accordingly ! look for -METIS_LEGACY in the command line arguments, and set legacy_partitioning accordingly
            ...
            if (arg == '-METIS_SEED') then
              if (i < num_args) then
                ...
                if(metis_random_seed < 0) then
                  ...
                  metis_random_seed = -metis_random_seed
                end if
              else 
